...
color: #000;
`
const CardBottomContainer1 = styled.div`
display: flex;
justify-content: space-between;
align-items: center;
z-index: 1001;
...
padding-bottom: 10px;
`
const CardBottomContainer2 = styled.div`
display: flex;
justify-content: space-between;
align-items: center;
z-index: 1001;
...
function AdminDashboard() {
 ...
 const handleView = () => {
  navigate('/admindashboard/callhistory')
 }
        ...
        <AdminSideBar />
         ...
         <Live>Dashboard</Live>
          ...
          <Card>
           ...
           <CardBottomContainer1 onClick={handleView}>
         ...
         <Grid container spacing={2}>
           <Grid item lg={3} md={3} sm={6} xs={12}>
            <Card3 style={{backgroundColor: '#FF3D60'}}>
            <ActiveInnerTopContainer style={{borderBottom: '1px solid #ff3d60'}}>
            <MissedCall style={{ color: '#fff'}}>Total Calls</MissedCall>
            ...
            <TimeSvg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><g fill="currentColor"><path d="M9 7h2v5h5v2H9V7Z"/><path fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10Zm-2 0a8 8 0 1 1-16 0a8 8 0 0 1 16 0Z" clip-rule="evenodd"/></g></TimeSvg>
              ...
              <Num style={{color: '#fff', textAlign: 'start', marginLeft: 15}}>34</Num>
              <CardBottomContainer2 onClick={handleView} >
            <ViewAll>View All</ViewAll>
            <BottomSvg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M4.8 21.57L7.222 24L19.2 12L7.222 0L4.8 2.43L14.347 12z"/></BottomSvg>
           ...
           <Grid item lg={3} md={3} sm={6} xs={12}>
           <Card3 style={{backgroundColor: '#31980D'}}>
           <ActiveInnerTopContainer>
            <MissedCall style={{ color: '#fff'}}>Incoming Calls</MissedCall>
            </ActiveInnerTopContainer>
            <Calltime>
            <TimeSvg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><g fill="currentColor"><path d="M9 7h2v5h5v2H9V7Z"/><path fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10Zm-2 0a8 8 0 1 1-16 0a8 8 0 0 1 16 0Z" clip-rule="evenodd"/></g></TimeSvg>
              Last 8h
              </Calltime>
              <Num style={{color: '#fff', textAlign: 'start', marginLeft: 15}}>95</Num>
          </Card3>

           </Grid>
           <Grid item lg={3} md={3} sm={6} xs={12}>
            <Card3 style={{backgroundColor: '#1982AF'}}>
            <ActiveInnerTopContainer>
            <MissedCall style={{ color: '#fff'}}>Outgoing Calls</MissedCall>
            </ActiveInnerTopContainer>
            <Calltime>
            <TimeSvg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><g fill="currentColor"><path d="M9 7h2v5h5v2H9V7Z"/><path fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10Zm-2 0a8 8 0 1 1-16 0a8 8 0 0 1 16 0Z" clip-rule="evenodd"/></g></TimeSvg>
              Last 8h
           ...
           <Grid item lg={3} md={3} sm={6} xs={12}>
           <Card3 style={{backgroundColor: '#CB310F'}}>
           <ActiveInnerTopContainer>
            <MissedCall style={{ color: '#fff'}}>Token Generated</MissedCall>
            </ActiveInnerTopContainer>
            <Calltime>
            <TimeSvg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><g fill="currentColor"><path d="M9 7h2v5h5v2H9V7Z"/><path fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10Zm-2 0a8 8 0 1 1-16 0a8 8 0 0 1 16 0Z" clip-rule="evenodd"/></g></TimeSvg>
              Last 8h
              </Calltime>
              <Num style={{color: '#fff', textAlign: 'start', marginLeft: 15}}>134</Num>
          </Card3>
           </Grid>
          </Grid>
          </CardContainer>
          ...
          <Grid item lg={8} md={8} sm={10} xs={12}>
           <Card2 style={{height: 410}}>
            <Grid container>
            <Grid item lg={7} md={7} sm={7} xs={7}>
             <CallFlow>Call Flow</CallFlow>
            </Grid>
